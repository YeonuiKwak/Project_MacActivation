'''csc score and medain poly(A) tail length comparison.'''
'''usage:
python <scriptName.py> <CDSfullsequence.fa> <output.txt>
input:CDS sequence.fasta
output: 1st column: Transcript # ID
        2nd column: Codon optimality score, mean CSC of all codons used in the CDS.
 '''

#Concatenate CDS exons into a single complete CDS.
#Problem : This CDS file was downloaded from santa cruze genome browser. this doesn't contain the TNFa gene.
import sys
inFile=open(sys.argv[1])
outFile=open(sys.argv[2],"w")
outFile_second=open(sys.argv[3],"w")
