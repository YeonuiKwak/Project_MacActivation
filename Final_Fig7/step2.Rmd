---
title: "Step2_ActD_Scatterplot of meanPAL"
author: "Yeonui+Kwak"
date: "8/16/2020"
...
final%>%drop_na()%>%nrow() #11128 isoforms in both biological replicates.
```
...
pdf("0and0:ActD.PAL_replicates_scattorplot.pdf", width = 3, height = 3)
...
pdf("1and1:Actd.PAL_replicates_scattorplot.pdf", width = 3, height = 3)
ggplot(t, aes(y = y, x = x)) + 
    geom_point(aes(col = density), size=1) + scale_color_identity() +
    theme_bw() + 
...
pdf("2and2:ActD.PAL_replicates_scattorplot.pdf", width = 3, height = 3)
ggplot(t, aes(y = y, x = x)) + 
    geom_point(aes(col = density), size=1) + scale_color_identity() +
    theme_bw() + 
