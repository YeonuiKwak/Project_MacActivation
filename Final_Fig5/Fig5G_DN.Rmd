...
sample=sample%>%filter(dCPS_diff %in% c("dCPS_1and2","dCPS_2and4"))%>%filter(dTED_group!="PAL_UP")
pdf("F5I_DN.pdf",width=4.5,height=2.5)
ggplot(sample%>%filter(dCPS_diff %in% c("dCPS_1and2","dCPS_2and4"))%>%filter(dTED_group!="PAL_UP"),aes(x=dTED_group,y=dCPS_value))+
...
sample=sample%>%filter(dTED_group!="PAL_UP")
